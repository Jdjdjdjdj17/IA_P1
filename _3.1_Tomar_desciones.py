...
def practica_4():
    print("=== 3.1.12: Fundamentos de la sentencia if-elif-else ===\n")
    print("""Escenario
...
Sería bueno verificar si el año ingresado cae en la era Gregoriana y emitir una advertencia de lo contrario: No dentro del período del calendario Gregoriano. Consejo: utiliza los operadores != y %.""")
    ...
    if a < 1582 : print("Fuera del periodo del calendario Gregoriano")
    elif a % 4 != 0 : print("Año comun")
    elif a % 100 != 0 : print("Año bisiesto")
    elif a % 400 != 0 : print("Año comun")
...
while True:
    ...
    print("4. 3.1.12 - Fundamentos de la sentencia if-elif-else")
    print("0. Salir")
